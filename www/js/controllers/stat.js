(function() {
	...
	angular
		...
		.controller('StatsController', function($scope, $ionicLoading, $ionicSlideBoxDelegate, StatResource, $window, common) {
					...
					yAxis: {
						...
						labels: {
							formatter: function() {
								...
								switch ('mb') {
								case 'mb':
									val = common.formatFileSize(val * 1024 * 1024);
									break;
								case '%':
								case '%%':
									val = val + '%';
									break;
								case 'ms':
									val = common.formatMiliseconds(val);
									break;
								default:
									val = common.formatSize(val);
								break;
								}
								return val;
							}
